...
def show_cart (access_token) : 
    ...
    for user_cart_model in user_cart_models :
        ...
        user_cart_model["product_url"] = get_specific_product.product_url
        user_cart_model["product_image"] = get_specific_product.product_image
    ...
    response_data['total_price'] = rupiah_format(total_price, True)
    response_data['detail_cart '] = user_cart_contain
